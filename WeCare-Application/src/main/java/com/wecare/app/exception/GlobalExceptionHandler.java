package com.wecare.app.exception;
...
public class GlobalExceptionHandler extends Exception {
	...
	public ResponseEntity<ErrorMessage> userNotFoundExceptionhandler(AppointmentNotFoundException e){
		ErrorMessage error = new ErrorMessage();
		error.setStatusCode(HttpStatus.BAD_REQUEST.value());
		error.setMessage(environment.getProperty(AppointmentConstants.APPPOINTMENT_NOT_FOUND.toString()));
		return new ResponseEntity<>(error,HttpStatus.BAD_REQUEST);
	...
	public ResponseEntity<ErrorMessage> lifeCoachNotFoundExceptionhandler(AppointmentNotFoundException e){
		ErrorMessage error = new ErrorMessage();
		error.setStatusCode(HttpStatus.BAD_REQUEST.value());
		error.setMessage(environment.getProperty(AppointmentConstants.APPPOINTMENT_NOT_FOUND.toString()));
		return new ResponseEntity<>(error,HttpStatus.BAD_REQUEST);
